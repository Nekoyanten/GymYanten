        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RequiereEquipo = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PesoUsadoKg = table.Column<decimal>(type: "decimal(6,2)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Progresos_AspNetUsers_ClienteId",
                        column: x => x.ClienteId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Progresos_Ejercicios_EjercicioId",
                        column: x => x.EjercicioId,
                        principalTable: "Ejercicios",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Progresos_Rutinas_RutinaId",
                        column: x => x.RutinaId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Progresos_EjercicioId",
                table: "Progresos",
                column: "EjercicioId");

            migrationBuilder.CreateIndex(
                name: "IX_Progresos_RutinaId",
                table: "Progresos",
                column: "RutinaId");
